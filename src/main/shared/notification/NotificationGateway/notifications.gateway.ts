  ...
  async handleConnection(client: Socket) {
    try {
      ...
      const payloadForSocketClient: PayloadForSocketClient = {
        ...
        createBranch: toggle.NotificationType === 'createBranch',
        createHuddle: toggle.NotificationType === 'createHuddle',
        useTemplate: toggle.NotificationType === 'useTemplate',
        createSessions: toggle.NotificationType === 'createSessions',
      };
